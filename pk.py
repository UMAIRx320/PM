...
for brayen in range(10000):
    rr = random.randint
    rc = random.choice
    u1 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; Google Pixel {str(rr(1,10))}XL Build/RPB3.{str(rr(1111111, 2100000))}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u2 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; Samsung Galaxy {rc(['Note 3', 'On8', 'S21', 'Note 10', 'A7', 'J2', 'M32', 'F12'])} Build/R16NW.{str(rr(1111111, 2100000))}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u3 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; HTC One {rc(['A9', 'E8', 'M9', 'X', 'E9t', 'X2'])} Build/LRX22G.{str(rr(1111111, 2100000))}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u4 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; Sony Xperia {rc(['XZ', 'L4', '10', 'L1', 'XZ2', 'XZ3', '5', 'Ace', 'Z', 'XA2'])} Build/RPB3.{str(rr(1111111, 2100000))}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u5 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; Moto {rc(['G4', 'G8', 'G41', 'X4', 'edge 30', 'G7 Plus', 'G9 Power'])} Build/RPB3.{str(rr(1111111, 2100000))}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    ...
    for isi in data.find_all("h3"):
        for ids in isi.find_all("a", href=True):
            if "profile.php" in ids.get("href"):
                id = ids.get("href").split('=')[1].replace("&refid", "")
            else:
                id = re.findall("/(.*?)?__", ids["href"])[0].replace("?refid=52&", "")
            nama = ids.text
            if id + "|" + nama in dump:
                pass
            else:
                dump.append(id + "|" + nama)
            sys.stdout.write(f"\r [+] Mengumpulkan {len(dump)} Idz...")
            sys.stdout.flush()
